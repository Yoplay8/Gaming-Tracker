package Consistant_Variables;// Consistent_Variables -  THIS NEEDS TO BE CHANGED.
...
public class Held_Variables 
{
	...
	public static int Screen_Height = 300;// This is the desired height to be used for all frames.
	...
	public static String File_Path = "Program_Files/";// This is the path to the folder where all the program files are saved.
